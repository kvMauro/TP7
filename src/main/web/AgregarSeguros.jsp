...
<%@page import="dao.ITipoSeguroDao"%>
<%@page import="dao.TipoSeguroDao"%>
<%@page import="dao.ISeguroDao"%>
...
<%
ISeguroDao seguros = new SeguroDao();
ITipoSeguroDao tiposDao = new TipoSeguroDao(); 
%>
...
<%
if(estado){%>
<b>SEGURO AGREGADO CON �XITO AL SISTEMA</b>
<%}%>
